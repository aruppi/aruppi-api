...
using System;
namespace JikanRest.Anime.Item.Reviews {
    /// <summary>
    /// Builds and executes requests for operations under \anime\{id}\reviews
    /// </summary>
    public class ReviewsRequestBuilder : BaseRequestBuilder {
        ...
        public ReviewsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/anime/{id}/reviews{?page*,preliminary*,spoiler*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReviewsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReviewsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/anime/{id}/reviews{?page*,preliminary*,spoiler*}", rawUrl) {
        }
