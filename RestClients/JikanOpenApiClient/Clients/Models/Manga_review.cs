...
namespace JikanRest.Models {
    public class Manga_review : Manga, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Manga_review_reactions? Reactions { get; set; }
#nullable restore
#else
        public Manga_review_reactions Reactions { get; set; }
#endif
...
#nullable restore
        ...
        public static new Manga_review CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Manga_review();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"reactions", n => { Reactions = n.GetObjectValue<Manga_review_reactions>(Manga_review_reactions.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Manga_review_reactions>("reactions", Reactions);
