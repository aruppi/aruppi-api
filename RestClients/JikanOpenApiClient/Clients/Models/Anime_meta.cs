...
namespace JikanRest.Models {
    public class Anime_meta : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new anime_meta and sets the default values.
        /// </summary>
        public Anime_meta() {
        ...
        public static Anime_meta CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Anime_meta();
        }
        /// <summary>
