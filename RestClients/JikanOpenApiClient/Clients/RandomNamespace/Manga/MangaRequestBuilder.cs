...
namespace JikanRest.RandomNamespace.Manga {
    /// <summary>
    /// Builds and executes requests for operations under \random\manga
    /// </summary>
    public class MangaRequestBuilder : BaseRequestBuilder {
        ...
        public MangaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/random/manga", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MangaRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MangaRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/random/manga", rawUrl) {
        }
