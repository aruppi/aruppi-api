...
using System;
namespace JikanRest.Top.Manga {
    /// <summary>
    /// Builds and executes requests for operations under \top\manga
    /// </summary>
    public class MangaRequestBuilder : BaseRequestBuilder {
        ...
        public MangaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/top/manga{?filter*,limit*,page*,type*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MangaRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MangaRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/top/manga{?filter*,limit*,page*,type*}", rawUrl) {
        }
...
#nullable restore
        ...
        public class MangaRequestBuilderGetQueryParameters {
            ...
            public Top_manga_filter? Filter { get; set; }
