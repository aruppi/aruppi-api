...
namespace JikanRest.Characters.Item.Full {
    /// <summary>
    /// Builds and executes requests for operations under \characters\{id}\full
    /// </summary>
    public class FullRequestBuilder : BaseRequestBuilder {
        ...
        public FullRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/characters/{id}/full", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FullRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FullRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/characters/{id}/full", rawUrl) {
        }
