...
namespace JikanRest.Producers.Item.Full {
    /// <summary>
    /// Builds and executes requests for operations under \producers\{id}\full
    /// </summary>
    public class FullRequestBuilder : BaseRequestBuilder {
        ...
        public FullRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/producers/{id}/full", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FullRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FullRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/producers/{id}/full", rawUrl) {
        }
