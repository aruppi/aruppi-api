...
using System;
namespace JikanRest.Anime.Item.Recommendations {
    /// <summary>
    /// Builds and executes requests for operations under \anime\{id}\recommendations
    /// </summary>
    public class RecommendationsRequestBuilder : BaseRequestBuilder {
        ...
        public RecommendationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/anime/{id}/recommendations", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RecommendationsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecommendationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/anime/{id}/recommendations", rawUrl) {
        }
