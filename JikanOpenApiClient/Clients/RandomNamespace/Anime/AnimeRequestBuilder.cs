...
namespace JikanRest.RandomNamespace.Anime {
    /// <summary>
    /// Builds and executes requests for operations under \random\anime
    /// </summary>
    public class AnimeRequestBuilder : BaseRequestBuilder {
        ...
        public AnimeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/random/anime", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AnimeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AnimeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/random/anime", rawUrl) {
        }
