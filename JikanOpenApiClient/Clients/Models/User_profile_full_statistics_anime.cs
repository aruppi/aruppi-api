...
namespace JikanRest.Models {
    ...
    /// Anime Statistics
    /// </summary>
    public class User_profile_full_statistics_anime : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new user_profile_full_statistics_anime and sets the default values.
        /// </summary>
        public User_profile_full_statistics_anime() {
        ...
        public static User_profile_full_statistics_anime CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new User_profile_full_statistics_anime();
        }
        /// <summary>
