...
namespace JikanRest.Models {
    public class Anime_full_relations : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new anime_full_relations and sets the default values.
        /// </summary>
        public Anime_full_relations() {
        ...
        public static Anime_full_relations CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Anime_full_relations();
        }
        /// <summary>
