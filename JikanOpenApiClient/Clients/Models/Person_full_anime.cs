...
namespace JikanRest.Models {
    public class Person_full_anime : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new person_full_anime and sets the default values.
        /// </summary>
        public Person_full_anime() {
        ...
        public static Person_full_anime CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Person_full_anime();
        }
        /// <summary>
