...
namespace JikanRest.Models {
    public class User_meta : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public User_images Images { get; set; }
#endif
        /// <summary>MyAnimeList Profile URL</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new user_meta and sets the default values.
        /// </summary>
        public User_meta() {
        ...
        public static User_meta CreateFromDiscriminatorValue(IParseNode parseNode) {
