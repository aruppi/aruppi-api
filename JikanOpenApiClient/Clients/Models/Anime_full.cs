...
namespace JikanRest.Models {
    ...
    /// Full anime Resource
    /// </summary>
    public class Anime_full : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Anime_full_external>? External { get; set; }
#nullable restore
#else
        public List<Anime_full_external> External { get; set; }
#endif
...
#nullable restore
        ...
        public Anime_full_rating? Rating { get; set; }
        /// <summary>The relations property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Anime_full_relations>? Relations { get; set; }
#nullable restore
#else
        public List<Anime_full_relations> Relations { get; set; }
#endif
        ...
        public Anime_full_season? Season { get; set; }
...
#nullable restore
        ...
        public Anime_full_status? Status { get; set; }
        /// <summary>The streaming property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Anime_full_streaming>? Streaming { get; set; }
#nullable restore
#else
        public List<Anime_full_streaming> Streaming { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Anime_full_theme? Theme { get; set; }
#nullable restore
#else
        public Anime_full_theme Theme { get; set; }
#endif
...
#nullable restore
        ...
        public Anime_full_type? Type { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new anime_full and sets the default values.
        /// </summary>
        public Anime_full() {
        ...
        public static Anime_full CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Anime_full();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"external", n => { External = n.GetCollectionOfObjectValues<Anime_full_external>(Anime_full_external.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"rating", n => { Rating = n.GetEnumValue<Anime_full_rating>(); } },
                {"relations", n => { Relations = n.GetCollectionOfObjectValues<Anime_full_relations>(Anime_full_relations.CreateFromDiscriminatorValue)?.ToList(); } },
                {"score", n => { Score = n.GetFloatValue(); } },
                {"scored_by", n => { ScoredBy = n.GetIntValue(); } },
                {"season", n => { Season = n.GetEnumValue<Anime_full_season>(); } },
                {"source", n => { Source = n.GetStringValue(); } },
                {"status", n => { Status = n.GetEnumValue<Anime_full_status>(); } },
                {"streaming", n => { Streaming = n.GetCollectionOfObjectValues<Anime_full_streaming>(Anime_full_streaming.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"theme", n => { Theme = n.GetObjectValue<Anime_full_theme>(Anime_full_theme.CreateFromDiscriminatorValue); } },
                ...
                {"type", n => { Type = n.GetEnumValue<Anime_full_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Anime_full_external>("external", External);
            ...
            writer.WriteEnumValue<Anime_full_rating>("rating", Rating);
            writer.WriteCollectionOfObjectValues<Anime_full_relations>("relations", Relations);
            writer.WriteFloatValue("score", Score);
            writer.WriteIntValue("scored_by", ScoredBy);
            writer.WriteEnumValue<Anime_full_season>("season", Season);
            writer.WriteStringValue("source", Source);
            writer.WriteEnumValue<Anime_full_status>("status", Status);
            writer.WriteCollectionOfObjectValues<Anime_full_streaming>("streaming", Streaming);
            writer.WriteCollectionOfObjectValues<Mal_url>("studios", Studios);
            writer.WriteStringValue("synopsis", Synopsis);
            writer.WriteObjectValue<Anime_full_theme>("theme", Theme);
            ...
            writer.WriteEnumValue<Anime_full_type>("type", Type);
