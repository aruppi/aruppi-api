...
namespace JikanRest.Models {
    public class Anime_statistics_data_scores : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new anime_statistics_data_scores and sets the default values.
        /// </summary>
        public Anime_statistics_data_scores() {
        ...
        public static Anime_statistics_data_scores CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Anime_statistics_data_scores();
        }
        /// <summary>
