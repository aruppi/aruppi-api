...
namespace JikanRest.Models {
    ...
    /// </summary>
    public class Anime_review_reactions : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new anime_review_reactions and sets the default values.
        /// </summary>
        public Anime_review_reactions() {
        ...
        public static Anime_review_reactions CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Anime_review_reactions();
        }
        /// <summary>
