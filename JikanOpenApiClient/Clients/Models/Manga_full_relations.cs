...
namespace JikanRest.Models {
    public class Manga_full_relations : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new manga_full_relations and sets the default values.
        /// </summary>
        public Manga_full_relations() {
        ...
        public static Manga_full_relations CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Manga_full_relations();
        }
        /// <summary>
