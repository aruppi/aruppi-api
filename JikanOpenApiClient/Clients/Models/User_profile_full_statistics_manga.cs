...
namespace JikanRest.Models {
    ...
    /// Manga Statistics
    /// </summary>
    public class User_profile_full_statistics_manga : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new user_profile_full_statistics_manga and sets the default values.
        /// </summary>
        public User_profile_full_statistics_manga() {
        ...
        public static User_profile_full_statistics_manga CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new User_profile_full_statistics_manga();
        }
        /// <summary>
