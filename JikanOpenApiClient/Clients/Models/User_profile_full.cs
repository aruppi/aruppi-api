...
namespace JikanRest.Models {
    ...
    /// </summary>
    public class User_profile_full : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<User_profile_full_external>? External { get; set; }
#nullable restore
#else
        public List<User_profile_full_external> External { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public User_profile_full_statistics? Statistics { get; set; }
#nullable restore
#else
        public User_profile_full_statistics Statistics { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new user_profile_full and sets the default values.
        /// </summary>
        public User_profile_full() {
        ...
        public static User_profile_full CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new User_profile_full();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"external", n => { External = n.GetCollectionOfObjectValues<User_profile_full_external>(User_profile_full_external.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"statistics", n => { Statistics = n.GetObjectValue<User_profile_full_statistics>(User_profile_full_statistics.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<User_profile_full_external>("external", External);
            ...
            writer.WriteObjectValue<User_profile_full_statistics>("statistics", Statistics);
