...
using System;
namespace JikanRest.Users.Item.Clubs {
    /// <summary>
    /// Builds and executes requests for operations under \users\{username}\clubs
    /// </summary>
    public class ClubsRequestBuilder : BaseRequestBuilder {
        ...
        public ClubsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{username}/clubs{?page*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ClubsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClubsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{username}/clubs{?page*}", rawUrl) {
        }
